...
var jsonTree = (function () {
  ...
  Tree.prototype = {
    ...
    loadData: function (jsonObj) {
      ...
      this.wrapper.appendChild(selectedElement);
    },
...
$("#SkipButtonForRequest").click(function () {
  ...
  $.ajax({
    ...
    success: function (results) {
      ...
      SourceJson = JSON.parse(results.request);
      stateVariableName =
        "NoRequestStateVariable_" + Math.round(Math.random() * 1000000);
      codeSnippet = results.codeSnippet;
      console.log(SourceJson);
      console.log(SelectedNodePath);
      console.log(apiName + "_" + stateVariableName);
      ...
      $.ajax({
        ...
        data: {
          ...
          SourceJson: JSON.stringify(SourceJson),
          SelectedNodePath: JSON.stringify(SelectedNodePath),
          stateVariableName: JSON.stringify(apiName + "_" + stateVariableName),
          codeSnippet: JSON.stringify(codeSnippet),
          jsonType: jsonType,
        },
        success: function (manipulateState_Results) {
          ...
          tree2.loadData(JSON.parse(results.response));
          tree2.expand();
        },
      });
    },
